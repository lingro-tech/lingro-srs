...
PROMPT = """
Clasificar la frase:
- false — mala (contiene nombre propio real, apelativo, número en cifras, abreviatura, palabra extranjera, jerga o símbolo especial).
- true — buena (frase neutra sin esos elementos).

Notas importantes:
- La mayúscula inicial por norma ortográfica NO se considera nombre propio.
- Se permiten signos de puntuación estándar (., , ; : ¡ ! ¿ ? « » " ").
- Símbolos especiales son únicamente hashtags (#), menciones (@), URLs y emojis.
- Formas verbales en imperativo, preguntas y repeticiones de palabras son válidas y no se consideran malas.
...
{"phrase":"Bébasela por mí","isGood":true,"reason":""}
{"phrase":"Cierra la cuerda","isGood":true,"reason":""}
{"phrase":"Vale vale vale","isGood":true,"reason":""}
{"phrase":"¿Quién podrá ser?","isGood":true,"reason":""}
